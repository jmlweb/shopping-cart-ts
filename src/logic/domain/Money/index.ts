 ...
 * This is useful if the case tomorrow the company decides to use an ERP with a different precision
 * and migrates the DB. Then, we will just need to change one constant.
 */
class Money {
