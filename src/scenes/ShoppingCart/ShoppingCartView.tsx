...
// Fake handleChange to stop eslint complaining about an input with value but not handler
const handleChange = <T extends unknown>(x: T) => x;

const ShoppingCartView: FC = () => (
      ...
      <ul className="products-list">
        <li className="product row">
          ...
          <div className="col-quantity">
            ...
            <input type="text" className="product-quantity" value="3" onChange={handleChange} />
            <button className="count">+</button>
          </div>
        ...
        <li className="product row">
          ...
          <div className="col-quantity">
            <button className="count">-</button>
            <input type="text" className="product-quantity" value="4" onChange={handleChange} />
            <button className="count">+</button>
          </div>
          <div className="col-price">
